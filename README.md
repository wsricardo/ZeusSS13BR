# ZeusSS13BR
 Zeus Static SIte 13  BR - Generate Static Blog Scripts with Python
 ...
 ## Vídeo Sobre a Criação da Ferramenta (Vlog)

 [Zeus Static - Video ](https://www.youtube.com/watch?v=QIl05RzuKQY)
...
- [Git ( ferramenta de controle de versões)](https://git-scm.com/)